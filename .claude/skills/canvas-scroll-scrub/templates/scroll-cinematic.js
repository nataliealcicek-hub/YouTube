...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Lenis is a progressive enhancement — if the CDN fails, fall back to native
  // scroll so the scrub still runs instead of the hero freezing on frame 0.
  ...
  else window.addEventListener("scroll", () => fadeHint(window.scrollY), { passive: true });
});
